...
public class AssociateImplementationTest {
	...
	public AssociateImplementationTest(List<Product> products, double sum, double min, double max, double avg,
			double median, Map<Warehouse, Double> totals) {
	...
	public static List<Object[]> generateTestData() {
		...
		// third test case
		list.add(new Object[] {
				Arrays.asList(new Object[] { new Product(1, "A", 0.01, 1000, wha), new Product(2, "B", 1.99, 3, wha),
						new Product(3, "C", 0.99, 0, whb), new Product(4, "D", 9.99, 20, whc),
						new Product(5, "E", 10, 1, wha), new Product(6, "F", 15, 5, whb),
						new Product(7, "G", 20, 8, whb), new Product(8, "H", 50, 2, whb) }),
				560.77, // sum
				0.01, // min
				50.00, // max
				13.50, // avg
		...
		// last test case
		list.add(new Object[] { Arrays.asList(new Object[] { new Product(1, "A", 2.55, 5, wha) }), 12.75, // sum
				2.55, // min
				2.55, // max
				2.55, // avg
				2.55, // median
